...
texinfo_documents = [
  ('index', 'FlightDataPlotter', u'FlightDataPlotter Documentation',
   u'Flight Data Services Ltd', 'FlightDataPlotter', 'One line description of project.',
   'Miscellaneous'),
]
...
pdf_documents = [ 
    ('index', pkg.__packagename__, pkg.__packagename__, pkg.__author__),
]
